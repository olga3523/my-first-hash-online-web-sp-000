def my_hash
  my_hash={"summer"=>"sunny"}# use the literal constructor to set the variable, my_hash, equal to a hash with key/value pairs of your choice.
...
def adding
  ...
  return# return the shipping_manifest hash below
